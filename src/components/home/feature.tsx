...
export function Feature() {
    ...
    return (
        <div className="flex flex-col items-center w-full h-[639px] py-10 relative overflow-hidden">
            ...
            <div className="flex w-[759px] h-[458px] absolute bg-cover top-20 right-28">
